...
-Desenvolver critérios técnicos para monitorar, avaliar e rebalancear uma carteira de investimentos.
    **Curadoria de Fontes:**
Os materiais abaixo foram selecionados para fundamentar este projeto, mesclando teoria matemática governamental com guias práticos de mercado. Eles serviram de base para as extrações de conhecimento no NotebookLM:
-[YouTube - Busca: Investindo na Bolsa de Valores]: Link da Pesquisa - Vídeos educativos sobre os primeiros passos e estratégias na renda variável.
-[Guia Investidor Tesouro Direto (ENAP)]: Link do PDF - Documento oficial detalhando o funcionamento, as taxas e os tipos de títulos da dívida pública federal.
-[Matemática Financeira (CAPES)]: Link do PDF - Material acadêmico sobre cálculo de juros, taxas equivalentes e amortização.
-[Mercado Pago - Como analisar seus investimentos]: Link do Artigo - Guia prático sobre indicadores de performance e avaliação de portfólio.
...
**Resultado obtido:** 
Resposta altamente técnica. A IA extraiu as fórmulas de montante composto e explicou a previsibilidade da curva de juros do Tesouro contra a volatilidade e o prêmio de risco exigido na Bolsa de Valores.
...
"Faça uma tabela comparativa detalhando: Tipo de Ativo, Risco, Liquidez e Benchmark ideal para [Tesouro Selic], [Tesouro IPCA+] e [Ações], usando estritamente as fontes fornecidas."
